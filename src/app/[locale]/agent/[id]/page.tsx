    ...
    <div className="min-h-screen">
      ...
      <section className="bg-brand-navy py-16 px-4">
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center gap-8">
          <div className="w-28 h-28 rounded-full bg-brand-gold/20 flex items-center justify-center flex-shrink-0">
            <span className="text-4xl font-heading font-bold text-brand-gold">
              {agent.name.charAt(0)}
            </span>
          </div>
          <div className="text-center md:text-left">
            ...
            <p className="text-white/70 text-lg mb-4">{agent.company}</p>
            <div className="flex flex-wrap gap-3 justify-center md:justify-start">
              <a
                href={`tel:${agent.phone}`}
                className="inline-flex items-center gap-2 px-4 py-2 bg-brand-gold text-white rounded-xl text-sm font-medium hover:bg-brand-gold-dark transition-colors"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 text-white rounded-xl text-sm font-medium hover:bg-white/20 transition-colors"
              >
      ...
      <div className="max-w-4xl mx-auto py-12 px-4">
        ...
        {/* Contact Info */}
        <section className="mb-12 p-6 bg-brand-cream rounded-2xl">
          <h2 className="text-xl font-heading font-bold text-brand-navy mb-4">
            {t("contactInfo")}
          </h2>
