  ...
  return (
    <div className={cn("relative inline-flex items-center", className)}>
      ...
      <select
        ...
        className="appearance-none pl-4 pr-10 py-2.5 rounded-xl border border-gray-200 bg-white text-sm text-brand-navy font-medium focus:outline-none focus:ring-2 focus:ring-brand-gold cursor-pointer"
      >
      ...
      <ChevronDown className="pointer-events-none absolute right-3 w-4 h-4 text-brand-navy" />
    </div>
  );
}
